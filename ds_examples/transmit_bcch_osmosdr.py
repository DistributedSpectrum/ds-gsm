...
# Title: GSM BCCH Transmitter OsmoSDR/SigMF
# Author: Bradley C.
...
class transmit_bcch_osmosdr(gr.top_block, Qt.QWidget):

    def __init__(self, fc=910e6, input_file_name="../test_data/gsm_downlink_BCCH_tail.sigmf-data", samp_rate=1e6, serial_id="", tx_gain_in=16):
        gr.top_block.__init__(self, "GSM BCCH Transmitter OsmoSDR/SigMF ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GSM BCCH Transmitter OsmoSDR/SigMF ")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "transmit_bcch_osmosdr")
...
def main(top_block_cls=transmit_bcch_osmosdr, options=None):
    if options is None:
