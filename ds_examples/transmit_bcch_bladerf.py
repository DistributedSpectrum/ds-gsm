...
# Title: GSM BCCH Transmitter bladeRF/SigMF
# Author: Bradley C.
...
class transmit_bcch_bladerf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fc=910e6, input_file_name="../test_data/gsm_downlink_BCCH_tail.sigmf-data", samp_rate=1e6, serial_id="", tx_gain_in=16):
        gr.top_block.__init__(self, "GSM BCCH Transmitter bladeRF/SigMF ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GSM BCCH Transmitter bladeRF/SigMF ")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "transmit_bcch_bladerf")
...
def main(top_block_cls=transmit_bcch_bladerf, options=None):
    if options is None:
