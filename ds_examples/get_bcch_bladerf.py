...
# Title: GSM BCCH Decoder bladeRF/SigMF
# Author: Bradley C
...
class get_bcch_bladerf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fc=910e6, input_file_name="../test_data/gsm_downlink_BCCH_tail.sigmf-data", osr=4, rx_gain=20, samp_rate_in=1e6, serial_id="", sigmf_enable=0):
        gr.top_block.__init__(self, "GSM BCCH Decoder bladeRF/SigMF ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GSM BCCH Decoder bladeRF/SigMF ")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "get_bcch_bladerf")
...
def main(top_block_cls=get_bcch_bladerf, options=None):
    if options is None:
